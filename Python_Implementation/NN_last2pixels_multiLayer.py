...
class NeuralNetwork:
    def __init__(self, input_size, hidden_size, hidden2_size, output_size):
        ...
        self.neurons_hidden = [Neuron(hidden2_size) for _ in range(hidden_size)]
    ...
    def forward_pass(self, x, y, last_r, last_g, last_b, last_r2, last_g2, last_b2):
        ...
        for neuron in self.neurons_hidden:
            hidden_outputs_vector.append(neuron.forward(hidden2_outputs_vector))
...
input_size = 8
model = NeuralNetwork(input_size, 3 ,3, 3)
...
image = "C:\\Users\\JoeyV\\OneDrive\\4510\\Projects\\augmented-reality-master (1)\\augmented-reality-master\\NN\\10x10.png"
    ...
    for p in range(1): 
        ...
        for j in range(10):
            for i in range(10):
                ...
                predicted_r, predicted_g, predicted_b = model.forward_pass((x/10)+0.5, (y/10)+0.5, last_predicted_r[0], last_predicted_g[0], last_predicted_b[0],last_predicted_b2[0], last_predicted_g2[0], last_predicted_b2[0])
