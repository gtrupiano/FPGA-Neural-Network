...
class NeuralNetwork:
    ...
    def forward_pass(self, x, y, last_r, last_g, last_b, last_r2, last_g2, last_b2, last_r3, last_g3, last_b3):
        input_vector = np.array([x,y,last_r,last_g,last_b,last_r2,last_g2,last_b2,last_r3,last_g3,last_b3]).reshape(-1, 1)
    ...
    def backward_pass(self, r, g, b, target_r, target_g, target_b):
        ...
        error_r = (r - target_r) * 0.5
        error_g = (g - target_g) * 0.5
        error_b = (b - target_b) * 0.5
...
input_size = 11
model = NeuralNetwork(input_size, 6 ,19, 3)
...
image = "C:\\Users\\JoeyV\\OneDrive\\4510\\Projects\\augmented-reality-master (1)\\augmented-reality-master\\NN\\box.png"
...
k = 0 
last_predicted_r, last_predicted_g, last_predicted_b = [0.5], [0.5], [0.5]
last_predicted_r2, last_predicted_g2, last_predicted_b2 = [0.5], [0.5], [0.5]
last_predicted_r3, last_predicted_g3, last_predicted_b3 = [0.5], [0.5], [0.5]
while k < 1250:
    k += 1    
    print(k)
    # x = 1
    ...
    for p in range(1): 
        ...
        for j in range(10):
            for i in range(10):
                ...
                predicted_r, predicted_g, predicted_b = model.forward_pass((x/10)+0.5, (y/10)+0.5, last_predicted_r[0], last_predicted_g[0], last_predicted_b[0],last_predicted_b2[0], last_predicted_g2[0], last_predicted_b2[0],last_predicted_b3[0], last_predicted_g3[0], last_predicted_b3[0])
                ...
                last_predicted_b3, last_predicted_g3, last_predicted_b3 = last_predicted_r2, last_predicted_g2, last_predicted_b2
